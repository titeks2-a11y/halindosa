...
- 생성 시각: 2026-06-06T07:09:07.598Z
- 원본 리포트 생성 시각: 2026-06-06T07:09:07.074Z
- 상태: fresh
- 리포트 나이: 0h
- 노출 공식 혜택: 46개
- 종료 노출: 0개
...
| Check | Status | Detail |
| --- | --- | --- |
| visible official benefits | PASS | 46 visible official benefit deals are available. |
...
| official source catalog | PASS | 35 official source candidates are tracked. |
