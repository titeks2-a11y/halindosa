...
- 생성 시각: 2026-06-04T01:32:50.408Z
- 원본 리포트 생성 시각: 2026-06-04T01:32:49.904Z
- 상태: fresh
- 리포트 나이: 0h
- 노출 공식 혜택: 30개
- 종료 노출: 0개
...
| Check | Status | Detail |
| --- | --- | --- |
| visible official benefits | PASS | 30 visible official benefit deals are available. |
...
| --- | --- | --- | ---: | --- |
| GS25 드링킹 페스타 1+1·다량 구매 행사 | GS25 | 2026-06-15 | 10.9 | 공식 페이지 종료 여부를 확인하고 대체 혜택 후보를 준비하세요. |
