...
- 생성 시각: 2026-06-06T16:00:33.339Z
- 원본 리포트 생성 시각: 2026-06-06T16:00:32.753Z
- 상태: fresh
- 리포트 나이: 0h
- 노출 공식 혜택: 78개
- 종료 노출: 0개
...
| Check | Status | Detail |
| --- | --- | --- |
| visible official benefits | PASS | 78 visible official benefit deals are available. |
...
| official source catalog | PASS | 67 official source candidates are tracked. |
...
| --- | --- | --- | ---: | --- |
| GS25 드링킹 페스타 1+1·다량 구매 행사 | GS25 | 2026-06-15 | 8.3 | 공식 페이지 종료 여부를 확인하고 대체 혜택 후보를 준비하세요. |
