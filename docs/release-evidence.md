...
- 생성 시각: 2026-06-05T18:31:08.727Z
- Git 브랜치: codex/12h-product-ux-growth-hardening
- 최신 커밋: e8a7ecd
- Git 상태: M STORE_MANUAL_CHECKLIST.json;  M STORE_MANUAL_CHECKLIST.md;  M STORE_SCREENSHOTS_REPORT.md;  M docs/STORE_MANUAL_CHECKLIST.md;  M docs/STORE_SCREENSHOTS_REPORT.md
- 패키지 버전: 1.0.1
- 앱 이름: 할인도사
...
| Image backlog mall request CSV | `IMAGE_BACKLOG_MALL_REQUESTS.csv` | 36KB |
