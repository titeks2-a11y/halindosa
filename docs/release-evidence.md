...
- Git 상태: M DEVICE_QA_REPORT.md
 ...
 M docs/STORE_SUBMISSION_REPORT.md
 M docs/SUPPORT_PLAYBOOK.md
- 패키지 버전: 1.0.0
- 앱 이름: 할인도사
