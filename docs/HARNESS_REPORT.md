...
Started: 2026-06-06T12:45:15.980Z
Finished: 2026-06-06T12:47:38.015Z
Status: PASS
...
✓ Generating static pages using 23 workers (205/205) in 1772ms
...
PASS home realtime data snapshot - 수집 산출물 56개가 updatedAt/verifiedAt/availability/source/finalUrl을 갖고 홈 no-store API로 반영될 준비가 되어 있습니다.
...
```text
cation-code: 14ms)
 GET /api/redirect/d132?from=smoke 302 in 16ms (next.js: 1543µs, application-code: 15ms)
 GET /api/redirect/d133?from=smoke 302 in 16ms (next.js: 1523µs, application-code: 14ms)
 GET /api/redirect/d134?from=smoke 302 in 16ms (next.js: 1745µs, application-code: 15ms)
 GET /api/redirect/d135?from=smoke 302 in 17ms (next.js: 1761µs, application-code: 15ms)
 GET /api/redirect/d136?from=smoke 302 in 16ms (next.js: 1660µs, application-code: 15ms)
 GET /api/redirect/d137?from=smoke 302 in 17ms (next.js: 1502µs, application-code: 16ms)
 GET /api/redirect/d138?from=smoke 302 in 16ms (next.js: 1494µs, application-code: 14ms)
 ...
 GET /api/redirect/d047?from=smoke 302 in 16ms (next.js: 1935µs, application-code: 14ms)
 GET /api/redirect/d054?from=smoke 302 in 17ms (next.js: 1897µs, application-code: 15ms)
 GET /api/redirect/d057?from=smoke 302 in 16ms (next.js: 1793µs, application-code: 14ms)
 GET /api/redirect/d061?from=smoke 302 in 17ms (next.js: 1670µs, application-code: 15ms)
 GET /api/redirect/d073?from=smoke 302 in 34ms (next.js: 18ms, application-code: 16ms)
 GET /api/redirect/d074?from=smoke 302 in 17ms (next.js: 1868µs, application-code: 15ms)
 GET /api/redirect/d115?from=smoke 302 in 17ms (next.js: 2ms, application-code: 15ms)
 GET /api/affiliate/status 200 in 109ms (next.js: 105ms, application-code: 4ms)
 GET /api/admin/export 200 in 150ms (next.js: 129ms, application-code: 21ms)
 GET /api/admin/deal-quality?format=csv 200 in 102ms (next.js: 91ms, application-code: 10ms)
 POST /api/admin/deal-quality 200 in 18ms (next.js: 1964µs, application-code: 16ms)
 GET /api/deals?limit=200 200 in 104ms (next.js: 66ms, application-code: 38ms)
 GET /api/redirect/d014?from=smoke-manual-hidden 404 in 19ms (next.js: 3ms, application-code: 16ms)
 POST /api/admin/deal-quality 200 in 17ms (next.js: 1856µs, application-code: 15ms)
 GET /api/redirect/d014?from=smoke-manual-restored 302 in 20ms (next.js: 4ms, application-code: 16ms)
 GET /api/admin/image-queue?format=csv 200 in 98ms (next.js: 73ms, application-code: 25ms)
 GET /robots.txt 200 in 115ms (next.js: 111ms, application-code: 4ms)
 GET /manifest.webmanifest 200 in 151ms (next.js: 147ms, application-code: 4ms)
 GET /sitemap.xml 200 in 192ms (next.js: 188ms, application-code: 4ms)
PASS home page (3393ms)
PASS home realtime api cache policy (1332ms)
PASS customer navigation simplification (0ms)
PASS home query filters (294ms)
PASS home empty search recovery (59ms)
PASS mypage data controls (520ms)
PASS auth pages (499ms)
PASS oauth callback and onboarding pages (452ms)
PASS account deletion guard (242ms)
PASS service guide page (470ms)
PASS support page (356ms)
PASS store screenshot preview (358ms)
PASS not found page (323ms)
PASS category and notification pages (5373ms)
PASS admin dashboard quality cards (8204ms)
PASS commercial launch readiness page (7467ms)
PASS deals api (90ms)
PASS news deals api (92ms)
PASS hot signals api internal discovery links (249ms)
PASS admin news operations api (134ms)
PASS admin news feed canary api (114ms)
PASS admin news feed live pipeline api (101ms)
PASS admin news feed preview api (167ms)
PASS admin source live readiness api (105ms)
PASS admin source live readiness csv (8ms)
PASS admin source onboarding plan api (96ms)
...
PASS admin source readiness rollup api (93ms)
...
PASS admin exposure policy api (97ms)
...
PASS partner feed sample validation api (12ms)
...
PASS go official news redirect (8238ms)
PASS detail purchase consent guard (4789ms)
PASS favorites page consent guard (479ms)
PASS verified purchase redirect destinations (870ms)
PASS affiliate status api (115ms)
PASS admin export csv (151ms)
PASS admin deal quality csv (103ms)
PASS admin manual hide affects public exposure (198ms)
PASS admin image queue csv (100ms)
PASS seo files (203ms)
...
PASS release evidence freshness - Working tree has pending changes; clean release candidates must refresh evidence after the final commit. Current document points at 7855866f.
PASS store manual checklist freshness - Working tree has pending changes; clean release candidates must refresh docs/STORE_MANUAL_CHECKLIST.md after the final commit. Current document points at 7855866f.
PASS device qa report freshness - Working tree has pending changes; clean release candidates must refresh docs/DEVICE_QA_REPORT.md after the final commit. Current document points at 7855866f.
PASS store screenshots report freshness - Working tree has pending changes; clean release candidates must refresh docs/STORE_SCREENSHOTS_REPORT.md after the final commit. Current document points at 7855866f.
PASS known issues freshness - Working tree has pending changes; clean release candidates must refresh docs/KNOWN_ISSUES.md after the final commit. Current document points at 7855866f.
PASS public url report freshness - Working tree has pending changes; clean release candidates must refresh docs/PUBLIC_URL_REPORT.md after the final commit. Current document points at 7855866f.
PASS store submission report freshness - Working tree has pending changes; clean release candidates must refresh docs/STORE_SUBMISSION_REPORT.md after the final commit. Current document points at 7855866f.
PASS store console fields freshness - Working tree has pending changes; clean release candidates must refresh docs/STORE_CONSOLE_FIELDS.md after the final commit. Current document points at 7855866f.
PASS store handoff report freshness - Working tree has pending changes; clean release candidates must refresh docs/STORE_HANDOFF_REPORT.md after the final commit. Current document points at 7855866f.
PASS release notes freshness - Working tree has pending changes; clean release candidates must refresh docs/RELEASE_NOTES.md after the final commit. Current document points at 7855866f.
PASS support playbook freshness - Working tree has pending changes; clean release candidates must refresh docs/SUPPORT_PLAYBOOK.md after the final commit. Current document points at 7855866f.
PASS store packet report freshness - Working tree has pending changes; clean release candidates must refresh docs/STORE_PACKET_REPORT.md after the final commit. Current document points at 7855866f.
