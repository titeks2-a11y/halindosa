...
- Commit: `412bd2dc`
- Working tree: M .github/workflows/ci.yml;  M DEVICE_QA_REPORT.md;  M LINK_VERIFICATION_REPORT.md;  M LINK_VERIFICATION_RESULT.json;  M data/linkValidationExposureOverrides.json;  M data/refreshedDeals.json;  M data/refreshedNewsDeals.json;  M docs/DEVICE_QA_REPORT.md;  M docs/EVENTS_REFRESH_REPORT.md;  M docs/FREEBIES_REFRESH_REPORT.md;  M docs/HEALTH_READINESS_REPORT.md;  M docs/NEWS_FEED_CANARY_REPORT.md;  M docs/OFFICIAL_SOURCE_LIVE_CHECK.md;  M docs/SOURCE_READINESS_REPORT.md;  M reports/events-refresh.json;  M reports/freebies-refresh.json
