...
- 생성 시각: 2026-06-13T11:24:33.627Z
...
| 게이트 | 상태 | 내용 | 다음 작업 |
| --- | --- | --- | --- |
| official source catalog | passed | 256개 공식 소스 후보, 누락 카테고리 0개, 얇은 카테고리 0개 | npm run source:catalog:report |
...
| consumer first source mix | passed | 소비자형 81%, 공공/정책성 19%, high priority 소비자형 73개 | npm run source:breadth:doctor |
