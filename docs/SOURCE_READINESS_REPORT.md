...
- 생성 시각: 2026-06-09T04:07:27.588Z
- 준비 상태: seed launch ready / 공식 feed 연결 대기
- 출시 게이트: passed
- 공식 소스 후보: 140개
- 접근 가능/보호 소스: 121개 / 19개
- 설정된 공식 feed URL: 0개
- 공식 혜택 노출 가능: 105개
- 차단 이슈: 0개
...
| 게이트 | 상태 | 내용 | 다음 작업 |
| --- | --- | --- | --- |
| official source catalog | passed | 140개 공식 소스 후보, 누락 카테고리 0개, 얇은 카테고리 0개 | npm run source:catalog:report |
| official source live | passed | 접근 가능 121개, 보호 19개, 차단 이슈 0개, 네트워크 점검 0개 | npm run source:live:doctor |
...
| PUBLIC_COUPON_FEED_URLS | ready_to_connect | 89 | 77 | 12 | 0 | PUBLIC_COUPON_FEED_URLS에 공식 JSON/RSS 또는 승인된 파트너 feed URL을 줄바꿈 또는 쉼표로 입력 |
| BENEFIT_REFRESH_FEED_URLS | ready_to_connect | 45 | 39 | 6 | 0 | BENEFIT_REFRESH_FEED_URLS에 공식 JSON/RSS 또는 승인된 파트너 feed URL을 줄바꿈 또는 쉼표로 입력 |
