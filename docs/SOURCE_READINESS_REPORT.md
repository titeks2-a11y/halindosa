...
- 생성 시각: 2026-06-13T11:35:39.844Z
- 준비 상태: seed launch ready / 공식 feed 연결 대기
- 출시 게이트: passed
- 공식 소스 후보: 264개
- 접근 가능/보호 소스: 224개 / 32개
- 설정된 공식 feed URL: 0개
- 공식 혜택 노출 가능: 197개
- 차단 이슈: 0개
- 소비자형 공식 혜택 소스: 216개 (82%)
...
| 게이트 | 상태 | 내용 | 다음 작업 |
| --- | --- | --- | --- |
| official source catalog | passed | 264개 공식 소스 후보, 누락 카테고리 0개, 얇은 카테고리 0개 | npm run source:catalog:report |
| official source live | passed | 접근 가능 224개, 보호 32개, 차단 이슈 0개, 네트워크 점검 0개 | npm run source:live:doctor |
...
| consumer first source mix | passed | 소비자형 82%, 공공/정책성 18%, high priority 소비자형 76개 | npm run source:breadth:doctor |
