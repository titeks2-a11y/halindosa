...
- 생성 시각: 2026-06-09T08:09:47.731Z
...
| 게이트 | 상태 | 내용 | 다음 작업 |
| --- | --- | --- | --- |
| official source catalog | passed | 160개 공식 소스 후보, 누락 카테고리 0개, 얇은 카테고리 0개 | npm run source:catalog:report |
...
| official benefit exposure | passed | 노출 127개, 숨김 0개, 종료 0개, 실패 0개 | npm run refresh:news && npm run verify:news |
