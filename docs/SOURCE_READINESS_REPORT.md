...
- 생성 시각: 2026-06-09T08:19:56.616Z
...
| official source live | passed | 접근 가능 135개, 보호 25개, 차단 이슈 0개, 네트워크 점검 0개 | npm run source:live:doctor |
...
| official benefit exposure | passed | 노출 135개, 숨김 0개, 종료 0개, 실패 0개 | npm run refresh:news && npm run verify:news |
