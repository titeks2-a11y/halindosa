...
- 생성 시각: 2026-06-07T13:36:43.542Z
- 운영 준비 점수: 100/100
- 상태: PASS
...
- 공식 feed canary: seed_fallback_only · fresh · 0.8시간 · 연결 0개 · 후보 0개
...
| official benefit freshness | PASS | Official benefit report freshness is 0.8h. |
...
| official feed canary | PASS | status=seed_fallback_only; freshness=fresh; age=0.8h; configured=0; visible=0. |
| provider risk gate | PASS | Official benefit providers danger=0, watch=4. |
| official source readiness gate | PASS | 95 official source candidates, 105 visible official benefits, failed gates=0. |
