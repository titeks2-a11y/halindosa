...
- 생성 시각: 2026-06-06T15:35:55.713Z
- 운영 준비 점수: 100/100
- 상태: PASS
...
- 공식 혜택 source mix: seed 79개 · 외부 feed 0개 · 성공 feed 0/0
...
| official_event | official_event_page_feed | seed/fallback | 37 | 36 | 36 | 0 | 0 |
| public_coupon | public_coupon_and_culture_benefit_feed | seed/fallback | 32 | 32 | 32 | 0 | 0 |
...
| official_event | seed 운영 | official_event_page_feed | 36 | 0 | 0% | 승인된 seed/fallback으로 운영 중입니다. |
| public_coupon | seed 운영 | public_coupon_and_culture_benefit_feed | 32 | 0 | 0% | 승인된 seed/fallback으로 운영 중입니다. |
...
| official benefit count floor | PASS | 78 official benefit deals are visible. |
...
| official feed source mix counters | PASS | seed=79, feed=0, success=0/0. |
...
| official source readiness gate | PASS | 67 official source candidates, 78 visible official benefits, failed gates=0. |
