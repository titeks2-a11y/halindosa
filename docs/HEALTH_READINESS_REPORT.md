...
- 생성 시각: 2026-06-09T07:59:26.986Z
- 운영 준비 점수: 100/100
- 상태: PASS
...
- 공식 feed canary: seed_fallback_only · fresh · 0.5시간 · 연결 0개 · 후보 0개
- 공식 혜택 Provider 위험도: 정상 0개 · 관찰 4개 · 즉시 점검 0개
- 공식 소스 통합 준비도: seed launch ready / 공식 feed 연결 대기
- 공식 소스 후보/노출 혜택: 157개 / 124개
- 공식 소스 차단 이슈: 0개
- 공식 혜택 리포트 신선도: 0시간
- refresh:all 상태: PASS
- cron refresh 상태: 수동 갱신 기준 정상 (manual_refresh_ready)
- 무료혜택 cron 상태: manual_refresh_ready · active 121개 · source 110개 · host 84개
...
| official benefit count floor | PASS | 124 official benefit deals are visible. |
...
| cron benefits operations | PASS | Cron benefits status=manual_refresh_ready; active=121; sources=110; hosts=84. |
...
| official feed canary | PASS | status=seed_fallback_only; freshness=fresh; age=0.5h; configured=0; visible=0. |
| provider risk gate | PASS | Official benefit providers danger=0, watch=4. |
| official source readiness gate | PASS | 157 official source candidates, 124 visible official benefits, blocking failed gates=0, advisory failed gates=0. |
