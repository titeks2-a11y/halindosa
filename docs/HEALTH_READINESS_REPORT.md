...
- 생성 시각: 2026-06-05T14:58:26.636Z
- 운영 준비 점수: 100/100
- 상태: PASS
...
| product hidden/failed queue | PASS | Customer exposure is clean with 131 visible deals; 9 hidden deals stay in the operator review queue. |
...
| official source readiness gate | PASS | 31 official source candidates, 43 visible official benefits, failed gates=0. |
