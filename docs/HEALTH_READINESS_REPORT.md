...
- 생성 시각: 2026-06-06T17:10:48.191Z
- 운영 준비 점수: 100/100
- 상태: PASS
...
- 공식 혜택 source mix: seed 85개 · 외부 feed 0개 · 성공 feed 0/0
...
| official_event | official_event_page_feed | seed/fallback | 43 | 42 | 42 | 0 | 0 |
...
| official_event | seed 운영 | official_event_page_feed | 42 | 0 | 0% | 승인된 seed/fallback으로 운영 중입니다. |
...
| official benefit count floor | PASS | 84 official benefit deals are visible. |
...
| official feed source mix counters | PASS | seed=85, feed=0, success=0/0. |
...
| official source readiness gate | PASS | 73 official source candidates, 84 visible official benefits, failed gates=0. |
