...
- 생성 시각: 2026-06-06T08:21:02.008Z
- 운영 준비 점수: 100/100
- 상태: PASS
...
- 공식 혜택 source mix: seed 52개 · 외부 feed 0개 · 성공 feed 0/0
...
| official_event | official_event_page_feed | seed/fallback | 28 | 28 | 28 | 0 | 0 |
| public_coupon | public_coupon_and_culture_benefit_feed | seed/fallback | 14 | 13 | 13 | 0 | 0 |
...
| official_event | seed 운영 | official_event_page_feed | 28 | 0 | 0% | 승인된 seed/fallback으로 운영 중입니다. |
| public_coupon | seed 운영 | public_coupon_and_culture_benefit_feed | 13 | 0 | 0% | 승인된 seed/fallback으로 운영 중입니다. |
...
| official benefit count floor | PASS | 51 official benefit deals are visible. |
...
| official feed source mix counters | PASS | seed=52, feed=0, success=0/0. |
...
| official source readiness gate | PASS | 40 official source candidates, 51 visible official benefits, failed gates=0. |
