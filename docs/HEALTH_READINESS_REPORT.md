...
- 생성 시각: 2026-06-10T19:47:13.278Z
- 운영 준비 점수: 100/100
- 상태: PASS
...
- 공식 혜택 source mix: seed 267개 · 외부 feed 0개 · 성공 feed 0/0
...
- 공식 소스 후보/노출 혜택: 212개 / 199개
- 공식 소스 차단 이슈: 0개
- 공식 혜택 리포트 신선도: 0시간
- refresh:all 상태: PASS
- cron refresh 상태: 수동 갱신 기준 정상 (manual_refresh_ready)
- 무료혜택 cron 상태: manual_refresh_ready · active 190개 · source 150개 · host 111개
...
| official_event | official_event_page_feed | seed/fallback | 181 | 132 | 132 | 0 | 0 |
...
| official_event | seed 운영 | official_event_page_feed | 132 | 0 | 0% | 승인된 seed/fallback으로 운영 중입니다. |
...
| official benefit count floor | PASS | 199 official benefit deals are visible. |
...
| cron benefits operations | PASS | Cron benefits status=manual_refresh_ready; active=190; sources=150; hosts=111. |
| provider stats coverage | PASS | Product providers=6, news providers=4. |
| official feed source mix counters | PASS | seed=267, feed=0, success=0/0. |
...
| official source readiness gate | PASS | PASS 212 official source candidates, 199 visible official benefits, blocking failed gates=0, advisory failed gates=0. Customer-visible official benefits remain covered by hard gates above. |
