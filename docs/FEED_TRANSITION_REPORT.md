...
- 생성 시각: 2026-06-06T11:55:07.855Z
...
| official_event | 공식 이벤트·혜택 | seed fallback | 29 | 0 | seed 운영 | OFFICIAL_EVENT_FEED_URLS, DEAL_EVENT_FEED_URLS | 상용 운영 전 가장 먼저 공식 이벤트 feed를 연결해 seed 의존도 축소 |
| public_coupon | 공공·쿠폰·무료혜택 | seed fallback | 17 | 0 | seed 운영 | PUBLIC_COUPON_FEED_URLS | 무료·쿠폰·포인트 혜택은 공식 수령 페이지가 있는 feed만 연결 |
