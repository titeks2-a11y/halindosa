...
- 생성 시각: 2026-06-06T17:09:26.038Z
...
| official_event | 공식 이벤트·혜택 | seed fallback | 42 | 0 | seed 운영 | OFFICIAL_EVENT_FEED_URLS, DEAL_EVENT_FEED_URLS | 상용 운영 전 가장 먼저 공식 이벤트 feed를 연결해 seed 의존도 축소 |
