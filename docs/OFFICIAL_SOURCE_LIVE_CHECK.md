...
- 생성 시각: 2026-06-13T11:36:01.204Z
...
| 상태 | 수 | 운영 액션 |
| --- | ---: | --- |
| reachable | 231 | 승인 feed 또는 공식 페이지 매핑 후보로 유지 |
| guarded | 33 | 공식 API/RSS/제휴 feed 확인 |
...
| naverpay-payment-benefit-list | official_event | high | reachable | 200 | pay.naver.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| naverpay-card-promotion-event | official_event | medium | reachable | 200 | card.pay.naver.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| shinhancard-mobile-event-list | official_event | medium | reachable | 200 | shinhancard.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| lottecard-mobile-event-list | official_event | medium | reachable | 200 | lottecard.co.kr | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| cu-official-plus-event-goods | official_event | high | reachable | 200 | cu.bgfretail.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| seven-eleven-official-service-event-menu | official_event | medium | reachable | 200 | 7-eleven.co.kr | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| lguplus-roaming-coupon-event | official_event | medium | reachable | 200 | lguplus.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| kbcard-official-event-list | official_event | medium | reachable | 200 | card.kbcard.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| hyundaicard-official-event-list | official_event | medium | guarded | 0 | hyundaicard.com | 공식 feed 연결 전 브라우저/제휴 담당자 확인 필요 |
| innisfree-official-event-list | official_event | high | reachable | 200 | innisfree.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
...
| tworld-official-ongoing-events | official_event | high | reachable | 200 | tworld.co.kr | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| skt-membership-tday-official-benefits | official_event | high | guarded | 200 | sktmembership.tworld.co.kr | 로그인/권한 페이지를 수집하지 말고 공식 API/RSS/제휴 feed 또는 수동 승인 매핑 사용 |
| kt-membership-partner-benefits | official_event | medium | guarded | 200 | membership.kt.com | 로그인/권한 페이지를 수집하지 말고 공식 API/RSS/제휴 feed 또는 수동 승인 매핑 사용 |
| daisomall-official-event-list | official_event | medium | reachable | 200 | daisomall.co.kr | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| shinhancard-official-event-list | official_event | medium | reachable | 200 | shinhancard.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| lottecard-official-event-list | official_event | medium | reachable | 200 | lottecard.co.kr | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| wooricard-official-event-list | official_event | medium | reachable | 200 | pc.wooricard.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| yeogiya-official-event-list | official_event | medium | reachable | 200 | yeogi.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| asiana-official-event-list | official_event | medium | guarded | 503 | flyasiana.com | 일시 장애 여부를 재확인하고 노출 데이터는 기존 검증 feed만 유지 |
| etlandmall-official-event-promotion | official_event | medium | reachable | 200 | etlandmall.co.kr | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| etlandmall-official-today-sale | official_event | medium | reachable | 200 | etlandmall.co.kr | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
...
| cjone-official-bonus-point-benefits | public_coupon | medium | reachable | 200 | cjone.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| cjone-official-gift-point-benefits | public_coupon | medium | reachable | 200 | cjone.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| happypoint-official-corporation-benefits | public_coupon | high | reachable | 200 | happypointcard.com | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| dominos-official-ecoupon-benefits | event_news | medium | reachable | 200 | web.dominos.co.kr | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| dominos-official-mania-membership-benefits | event_news | medium | reachable | 200 | web.dominos.co.kr | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| lge-official-membership-benefits | official_event | medium | guarded | 200 | lge.co.kr | 로그인/권한 페이지를 수집하지 말고 공식 API/RSS/제휴 feed 또는 수동 승인 매핑 사용 |
| emart24-official-active-events | official_event | high | reachable | 200 | emart24.co.kr | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
| emart24-official-event-goods-benefits | official_event | high | reachable | 200 | emart24.co.kr | 승인 feed 후보로 유지하고 refresh:news 또는 수동 매핑에 연결 |
