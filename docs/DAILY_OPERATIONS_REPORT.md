...
- 생성 시각: 2026-06-06T11:22:51.498Z
- 운영 상태: 오늘 운영 가능
- 상품 링크: 140/140 검증
- 검색 링크 노출: 0건
- 품절/종료 상품 노출: 0건
...
| 공식 혜택 노출 | passed | 공식 혜택 52개, 숨김 0개, 종료 0개, 실패 0개 | npm run refresh:news && npm run verify:news |
...
| 공식 혜택 | good | 52개 | 무료, 쿠폰, 카드, 문화, 공공 혜택의 공식 링크 노출 상태입니다. | npm run verify:news |
