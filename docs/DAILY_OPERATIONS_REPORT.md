...
- 생성 시각: 2026-06-09T04:07:48.026Z
- 운영 상태: 오늘 운영 가능
- 상품 링크: 140/140 검증
- 검색 링크 노출: 0건
- 품절/종료 상품 노출: 0건
...
| 공식 소스 준비도 | passed | 공식 소스 140개, launch gate=passed | npm run source:readiness:report |
...
| 공식 소스 | good | 140개 | 향후 API/RSS/제휴 feed 전환 후보와 정책 게이트입니다. | npm run source:readiness:report |
