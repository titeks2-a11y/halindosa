...
- 생성 시각: 2026-06-11T20:29:17.320Z
- 상태: seed_ready
- 설정 feed URL: 0개
- 설정 provider: 0개
- canary 노출 후보: 0개
...
| official source live readiness | PASS | reachable=185, guarded=26, stale=0 | Run npm run source:live:doctor and replace or remove any stale_or_removed official source before feed activation. |
...
| official benefit floor | PASS | visible=199, threshold=95 | Run npm run health:readiness after activation to confirm visible official benefits and freshness. |
