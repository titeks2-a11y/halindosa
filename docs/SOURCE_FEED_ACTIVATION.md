...
- 생성 시각: 2026-06-10T17:35:07.686Z
- 상태: seed_ready
- 설정 feed URL: 0개
- 설정 provider: 0개
- canary 노출 후보: 0개
...
| official source live readiness | PASS | reachable=185, guarded=27, stale=0 | Run npm run source:live:doctor and replace or remove any stale_or_removed official source before feed activation. |
| official source breadth readiness | PASS | lanes=12/12, brandSignals=57/57, consumer=77%, publicPolicy=23% | Run npm run source:breadth:doctor so telecom, convenience, beauty, cafe, delivery, pay, mart, open-market, public, education, pet, sample lanes, and consumer-first source mix stay covered. |
...
| official benefit floor | PASS | visible=173, threshold=95 | Run npm run health:readiness after activation to confirm visible official benefits and freshness. |
