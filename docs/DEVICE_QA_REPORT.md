...
- Commit: `bc4e7130`
- Working tree: M LINK_VERIFICATION_REPORT.md;  M LINK_VERIFICATION_RESULT.json;  M STORE_MANUAL_CHECKLIST.json;  M STORE_MANUAL_CHECKLIST.md;  M data/linkValidationExposureOverrides.json;  M data/refreshedDeals.json;  M data/refreshedNewsDeals.json;  M docs/STORE_MANUAL_CHECKLIST.md;  M docs/release-evidence.md
- Debug APK: missing
- Release AAB: missing
