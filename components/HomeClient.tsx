...
import {
  ...
  type FreeBenefitEventCollectionLane,
    ...
    async ({ notify = false, silent = false }: { notify?: boolean; silent?: boolean } = {}) => {
      ...
      try {
        if (await shouldUseLocalBundleData()) {
          ...
          const referenceNow = Date.now();
          const nextBundleEvents = selectPublishableFreeBenefitEvents(initialNewsDeals, HOME_FREEBIE_EVENT_LIMIT, referenceNow);
          ...
          setHomeFreeBenefitCollectionLanes(buildFreeBenefitEventCollectionLanes(nextBundleEvents));
