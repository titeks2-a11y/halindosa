...
- 검색 결과 핵심 요약으로 많은 판매처, 최대 할인, 최저 현재가, 마감 임박 수를 첫 화면에서 확인
...
검색 패널은 현재 조건 기준의 `검색 결과 핵심 요약`도 함께 보여줍니다. 많은 판매처, 최대 할인, 최저 현재가, 마감 임박 수를 먼저 보여줘 긴 목록을 내려보기 전에 어떤 기준으로 볼지 빠르게 판단할 수 있습니다.
