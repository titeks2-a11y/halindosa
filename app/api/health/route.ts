  ...
  try {
    ...
    return NextResponse.json({
      ...
      checks: {
        ...
        freeBenefitInstantClaimCount: freeBenefitRanking.instantClaimCount,
        freeBenefitTopClaimReadyCount: freeBenefitRanking.topClaimReadyCount,
        freeBenefitTopInstantClaimCount: freeBenefitRanking.topInstantClaimCount,
        ...
        freeBenefitInstantClaimShare: freeBenefitRanking.operationalReadiness.instantClaimShare,
        freeBenefitClaimAccessLevelCounts: freeBenefitRanking.claimAccessLevelCounts,
