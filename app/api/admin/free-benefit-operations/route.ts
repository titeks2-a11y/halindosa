...
type FreeBenefitOperationsReport = {
  ok?: boolean;
  generatedAt?: string;
  totals?: {
...
function readReport(): FreeBenefitOperationsReport {
...
function buildFreeBenefitOperationsCsv(report: FreeBenefitOperationsReport) {
