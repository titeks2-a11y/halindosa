...
if ((freebiesReport.visibleCount ?? 0) < 5) sliceIssues.push("freebies report visible count is below launch floor");
...
if ((eventsReport.visibleCount ?? 0) < 30) sliceIssues.push("events report visible count is below launch floor");
