...
const artifacts = [
  ...
  ["Official benefit alert report", "docs/OFFICIAL_BENEFIT_ALERTS_REPORT.md"],
  ["Official benefit alert JSON", "reports/official-benefit-alerts.json"],
  ["Link quality regression JSON", "reports/link-quality-regression.json"],
  ["Official source live check report", "docs/OFFICIAL_SOURCE_LIVE_CHECK.md"],
  ["Official source live check JSON", "reports/official-source-live-check.json"],
  ["Official source live check CSV", "reports/official-source-live-check.csv"],
  ["Official source onboarding plan", "docs/SOURCE_ONBOARDING_PLAN.md"],
  ["Official source onboarding JSON", "reports/source-onboarding-plan.json"],
  ["Official source onboarding CSV", "reports/source-onboarding-plan.csv"],
