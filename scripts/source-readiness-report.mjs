...
const gates = [
  ...
  buildGate(
    ...
    news.ok === true && visibleOfficialBenefits >= 70 && numberValue(news.hiddenCount) === 0 && numberValue(news.expiredCount) === 0 && numberValue(news.failedCount) === 0,
  ...
  buildGate(
    ...
    refreshAllOk && numberValue(refreshAll.productDealsCount) >= 140 && numberValue(refreshAll.newsDealsCount) >= 70 && numberValue(refreshAll.failedCount) === 0,
