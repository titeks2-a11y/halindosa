...
async function checkPackage() {
  ...
  if (
    ...
    pass("free benefit security gates", "refresh:benefits, verify:benefits, benefit:priority:doctor, benefit:event:contract, official source catalog security guard, and security:check are wired into qa, harness, and release doctor policy.");
  }
