...
function checkFreeBenefitOperationsReport() {
  ...
  for (const phrase of ["무료혜택 랭킹 리포트", "freeBenefitRankingApiHref", "freeBenefitRankingCsvHref", "정확 중복", "첫 화면 상위 후보", "첫 화면 반복", "24시간 검증", "공식 도메인", "바로받기 비율"]) {
