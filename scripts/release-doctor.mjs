...
async function checkPackage() {
  ...
  else if (!pkg.scripts?.qa?.includes("admin:auth:doctor") || !pkg.scripts?.qa?.includes("verify:links") || !pkg.scripts?.qa?.includes("verify:links:live") || !pkg.scripts?.qa?.includes("verify:products") || !pkg.scripts?.qa?.includes("link:policy:regression") || !pkg.scripts?.qa?.includes("exposure:doctor") || !pkg.scripts?.qa?.includes("surface:publishable:doctor") || !pkg.scripts?.qa?.includes("link:launch:gate") || !pkg.scripts?.qa?.includes("link:revalidation:report") || !pkg.scripts?.qa?.includes("live:probe:review") || !pkg.scripts?.qa?.includes("refresh:deals") || !pkg.scripts?.qa?.includes("refresh:news") || !pkg.scripts?.qa?.includes("refresh:freebies") || !pkg.scripts?.qa?.includes("refresh:events") || !pkg.scripts?.qa?.includes("verify:news") || !pkg.scripts?.qa?.includes("news:freshness:doctor") || !pkg.scripts?.qa?.includes("news:revalidation:report") || !pkg.scripts?.qa?.includes("test:news-feed-errors") || !pkg.scripts?.qa?.includes("test:news-feed-dry-run") || !pkg.scripts?.qa?.includes("refresh:all") || !pkg.scripts?.qa?.includes("health:readiness") || !pkg.scripts?.qa?.includes("push:readiness:report") || !pkg.scripts?.qa?.includes("push:delivery:doctor") || !pkg.scripts?.qa?.includes("push:delivery:audit") || !pkg.scripts?.qa?.includes("official:alerts:report") || !pkg.scripts?.qa?.includes("source:catalog:report") || !pkg.scripts?.qa?.includes("source:live:doctor") || !pkg.scripts?.qa?.includes("source:onboarding:plan") || !pkg.scripts?.qa?.includes("source:feed-env:doctor") || !pkg.scripts?.qa?.includes("source:readiness:report") || !pkg.scripts?.qa?.includes("home:realtime:doctor") || !pkg.scripts?.qa?.includes("test:home-realtime") || !pkg.scripts?.qa?.includes("test:mobile-compact") || !pkg.scripts?.qa?.includes("verify:images") || !pkg.scripts?.["admin:auth:doctor"]?.includes("admin-auth-doctor.mjs") || !pkg.scripts?.["link:policy:regression"]?.includes("link-quality-regression.mjs") || !pkg.scripts?.["surface:publishable:doctor"]?.includes("publishable-surface-doctor.mjs") || !pkg.scripts?.["link:launch:gate"]?.includes("link-launch-gate.mjs") || !pkg.scripts?.["link:revalidation:report"]?.includes("link-revalidation-priority-report.mjs") || !pkg.scripts?.["live:probe:review"]?.includes("live-probe-review-report.mjs") || !pkg.scripts?.["news:revalidation:report"]?.includes("news-revalidation-priority-report.mjs") || !pkg.scripts?.["refresh:freebies"]?.includes("refresh-official-benefit-slice.mjs freebies") || !pkg.scripts?.["refresh:events"]?.includes("refresh-official-benefit-slice.mjs events") || !pkg.scripts?.["refresh:all"]?.includes("refresh-all.mjs") || !pkg.scripts?.["health:readiness"]?.includes("health-readiness-report.mjs") || !pkg.scripts?.["push:readiness:report"]?.includes("push-readiness-report.mjs") || !pkg.scripts?.["push:delivery:doctor"]?.includes("push-delivery-policy-doctor.mjs") || !pkg.scripts?.["push:delivery:audit"]?.includes("push-delivery-audit-doctor.mjs") || !pkg.scripts?.["official:alerts:report"]?.includes("official-benefit-alert-report.mjs") || !pkg.scripts?.["news:freshness:doctor"]?.includes("news-freshness-doctor.mjs") || !pkg.scripts?.["source:catalog:report"]?.includes("official-source-catalog-report.mjs") || !pkg.scripts?.["source:live:doctor"]?.includes("official-source-live-doctor.mjs") || !pkg.scripts?.["source:onboarding:plan"]?.includes("source-onboarding-plan.mjs") || !pkg.scripts?.["source:feed-env:doctor"]?.includes("source-feed-env-doctor.mjs") || !pkg.scripts?.["source:readiness:report"]?.includes("source-readiness-report.mjs") || !pkg.scripts?.["home:realtime:doctor"]?.includes("home-realtime-doctor.mjs") || !pkg.scripts?.["test:home-realtime"]?.includes("home-realtime-doctor.mjs") || !pkg.scripts?.["test:mobile-compact"]?.includes("test-mobile-ux.mjs") || !pkg.scripts?.["verify:images"]?.includes("verify-images.mjs") || !harness.includes("test:mobile-ux") || !harness.includes("test:mobile-compact") || !harness.includes("home:realtime:doctor") || !harness.includes("test:home-realtime") || !harness.includes("verify:images") || !pkg.scripts?.qa?.includes("test:mobile-ux") || !pkg.scripts?.["env:doctor:production"]?.includes("--production") || !pkg.scripts?.["qa:release"]?.includes("health:readiness") || !pkg.scripts?.["qa:release"]?.includes("audit:commercial") || !pkg.scripts?.["qa:release"]?.includes("test:env") || !pkg.scripts?.["qa:release"]?.includes("device:qa:manifest") || !pkg.scripts?.["qa:release"]?.includes("device:qa:doctor") || !pkg.scripts?.["qa:release"]?.includes("device:qa:report") || !pkg.scripts?.["qa:release"]?.includes("android:signing:doctor") || !pkg.scripts?.["qa:release"]?.includes("public:url:doctor") || !pkg.scripts?.["qa:release"]?.includes("feed:validate") || !pkg.scripts?.["qa:release"]?.includes("feed:production:doctor") || !pkg.scripts?.["qa:release"]?.includes("store:metadata:doctor") || !pkg.scripts?.["qa:release"]?.includes("store:submission:report") || !pkg.scripts?.["qa:release"]?.includes("store:packet:doctor") || !pkg.scripts?.["qa:release"]?.includes("store:console:fields") || !pkg.scripts?.["qa:release"]?.includes("store:manual:checklist") || !pkg.scripts?.["qa:release"]?.includes("store:manual:doctor") || !pkg.scripts?.["qa:release"]?.includes("store:handoff:report") || !pkg.scripts?.["qa:release"]?.includes("release:notes") || !pkg.scripts?.["qa:release"]?.includes("support:playbook") || !pkg.scripts?.["qa:release"]?.includes("known:issues") || !pkg.scripts?.["qa:release"]?.includes("store:assets:doctor") || !pkg.scripts?.["qa:release"]?.includes("store:screenshots:manifest") || !pkg.scripts?.["qa:release"]?.includes("store:screenshots:doctor") || !pkg.scripts?.["qa:release"]?.includes("perf:budget")) {
...
function checkHealthReadinessReport() {
  ...
  if ((report.officialBenefits?.visibleCount ?? 0) < 60) issues.push("health readiness should show at least 60 official benefits");
  ...
  if ((report.sourceReadiness?.officialSourceCandidates ?? 0) < 30 || (report.sourceReadiness?.visibleOfficialBenefits ?? 0) < 60) {
  ...
  if ((report.cronRefresh?.productDealsCount ?? 0) < 140 || (report.cronRefresh?.newsDealsCount ?? 0) < 60) {
...
function checkDailyOperationsReport() {
  ...
  if ((report.summary?.visibleOfficialBenefits ?? 0) < 60) issues.push("daily operations should show at least 60 official benefits");
...
function checkCronRefreshPipeline() {
  ...
  if (cronReadinessReport?.livePipelineOk !== true || (cronReadinessReport?.livePipelineOfficialBenefits ?? 0) < 60) {
