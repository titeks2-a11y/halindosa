...
async function checkPackage() {
  ...
  const firstPartyFeedContractDoctor = await text("scripts/first-party-free-benefit-feed-contract-doctor.mjs");
  ...
  if (
    ...
    !String(pkg.scripts?.qa ?? "").includes("benefit:platform:report") ||
    ...
    !harness.includes("benefit:first-party-feed:contract") ||
    !harness.includes("benefit:event:contract") ||
    !harness.includes("benefit:priority:doctor") ||
    !harness.includes("benefit:platform:report") ||
    ...
    !firstPartyFeedContractDoctor.includes("firstPartyFeedUrl") ||
    !firstPartyFeedContractDoctor.includes("BENEFIT_REFRESH_FEED_URLS") ||
    !firstPartyFeedContractDoctor.includes("blockedSearchLinkItems") ||
    !firstPartyFeedContractDoctor.includes("topCandidateClaimUrlCount") ||
