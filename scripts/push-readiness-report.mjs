...
const checks = [
  ...
  Number(newsQuality.visibleCount ?? refreshAll.newsDealsCount ?? 0) >= 60
    ? pass("official benefit base", "공식 혜택 60개 이상을 알림 후보로 사용할 수 있습니다.")
    : fail("official benefit base", "공식 혜택 알림 후보가 60개 미만입니다."),
