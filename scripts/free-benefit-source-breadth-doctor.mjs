...
const requiredBrandSignals = [
  ...
  { id: "shinhancard", label: "신한카드", patterns: [/shinhancard|신한카드|신한solpay|신한쏠페이/i] },
  { id: "samsungcard", label: "삼성카드", patterns: [/samsungcard|삼성카드/i] },
  { id: "lottecard", label: "롯데카드", patterns: [/lottecard|롯데카드/i] },
  { id: "kbcard", label: "KB국민카드", patterns: [/kbcard|국민카드|kb pay|kbpay/i] },
