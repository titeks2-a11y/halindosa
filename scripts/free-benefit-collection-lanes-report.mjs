...
| --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
${lanes.map((lane) => `| ${lane.label} | ${lane.status} | ${lane.count} | ${lane.minimum} | ${lane.officialCount} | ${lane.noPurchaseCount} | \`${lane.envKey}\` | ${lane.recommendedEnvKeys.map((envKey) => `\`${envKey}\``).join("<br>")} | ${lane.action} |`).join("\n")}
