...
const fullSteps = [
  ...
  ["benefit:collection:report", ["run", "benefit:collection:report"]],
  ["benefit:model:doctor", ["run", "benefit:model:doctor"]],
  ...
  ["benefit:first-party-feed:contract", ["run", "benefit:first-party-feed:contract"]],
