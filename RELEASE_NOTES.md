...
| `docs/STORE_HANDOFF_REPORT.md` | present (7280 bytes) |
...
- `0f8c44f1 perf: trim home initial bundle for deployment`
- `7e4d3462 test: guard free benefits initial payload`
- `5a592b28 perf: trim initial free benefits payload`
- `d4e6bca1 chore: surface tracked generated report files`
- `23a01de3 security: enforce no-store cron refresh routes`
- `e4019d12 test: cover image proxy abuse guard in smoke`
- `3b39ccda security: harden image proxy validation`
- `da482b42 fix: default official benefits to consumer first exposure`
