...
export const mockDeals: Deal[] = [
  ...
  deal("d071", "카카오페이", "카카오페이 결제 리워드 스탬프 이벤트", "쿠폰/이벤트", 3000, 100, 0.5, 16, { isHot: true, isNew: true, isEndingSoon: true }, ["페이", "포인트", "리워드", "앱테크"], 91, "", "https://kakaopay.com/services/life/payment?t_ch=main&t_src=homepage"),
