...
export const mockDeals: Deal[] = [
  ...
  deal("d058", "배달의민족", "배달앱 첫 주문 5천원 할인 쿠폰", "쿠폰/이벤트", 5000, 100, 0.4, 12, { isHot: true, isNew: true, isEndingSoon: true }, ["배달", "외식", "첫 구매", "쿠폰"], 92, "", "https://academy.baemin.com/event/list"),
