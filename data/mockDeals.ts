...
export const mockDeals: Deal[] = [
  deal("d001", "롯데온", "삼성 86인치 4K 스마트 UHD TV", "전자기기", 1201350, 26, 0.1, 18, { isHot: true, isNew: true, isEndingSoon: false }, ["실시간", "핫딜", "무료배송"], 99, "/deal-images/live-707648.jpg", "https://www.lotteon.com/p/product/LO2252516987"),
  deal("d002", "지마켓", "새우깡 8봉 + 매운새우깡 8봉", "식품", 19160, 25, 0.2, 12, { isHot: true, isNew: true, isEndingSoon: false }, ["실시간", "무료배송", "인기"], 95, "/deal-images/live-707791.jpg", "https://item.gmarket.co.kr/Item?goodsCode=4076233103"),
  deal("d003", "g마켓", "국내산 돌산갓김치 1.5kg", "식품", 11080, 24, 0.3, 10, { isHot: true, isNew: true, isEndingSoon: false }, ["실시간", "무배", "오늘만"], 92, "/deal-images/live-707790.jpg", "https://item.gmarket.co.kr/Item?goodsCode=1645289356"),
  ...
  deal("d006", "쿠팡", "닥터유 제주용암수 2L 18병", "식품", 13940, 29, 0.6, 14, { isHot: true, isNew: true, isEndingSoon: false }, ["실시간", "무료배송", "생활필수"], 89, "/deal-images/live-707786.jpg", "https://www.coupang.com/vp/products/4944747674?itemId=19547724956&vendorItemId=86433745874"),
  deal("d007", "토스", "돼지목살 양념구이 600g X 4팩", "식품", 27500, 28, 0.7, 7, { isHot: true, isNew: true, isEndingSoon: true }, ["실시간", "무료배송", "한정수량"], 88, "/deal-images/live-707785.jpg", "https://item.gmarket.co.kr/Item?goodscode=2845354348"),
  deal("d008", "LF몰", "아이더 POP ON 남성 여름 냉감 폴로 티셔츠", "의류", 42190, 27, 0.8, 20, { isHot: true, isNew: true, isEndingSoon: false }, ["실시간", "무배", "패션"], 87, "/deal-images/live-707784.jpg", "https://www.lfmall.co.kr/app/product/E3GKXX00844"),
  deal("d009", "지마켓", "신라면+너구리+짜파게티+오징어짬뽕 총 20봉", "식품", 19780, 26, 0.9, 11, { isHot: true, isNew: true, isEndingSoon: false }, ["실시간", "쿠폰적용", "무배"], 86, "/deal-images/live-707783.jpg", "https://item.gmarket.co.kr/Item?goodscode=3768639920"),
  ...
  deal("d026", "하이마트", "HP 오멘 16-am0121TX RTX5070 게이밍노트북", "전자기기", 2299000, 9, 7, 44, { isHot: true, isNew: false, isEndingSoon: false }, ["카드할인", "한정수량"], 88),
  deal("d027", "GS SHOP", "군 기저귀 프리미엄 밴드 대형 36P 4팩", "육아", 128000, 36, 9, 19, { isHot: false, isNew: false, isEndingSoon: false }, ["무료배송", "쿠폰적용"], 73),
  ...
  deal("d037", "무신사", "더니트컴퍼니 수피마 에센셜 티셔츠 3PACK", "의류", 69000, 52, 4, 18, { isHot: false, isNew: true, isEndingSoon: true }, ["무배", "패션", "마감임박"], 83),
  ...
  deal("d053", "BC카드", "BC카드 페이북 보너스 머니박스 이벤트", "쿠폰/이벤트", 10000, 100, 0.3, 30, { isHot: true, isNew: true, isEndingSoon: false }, ["카드", "페이북", "보너스머니", "공식이벤트"], 91, "", "https://www.bccard.com/app/card/event/main/MainActn.do"),
  deal("d054", "카카오페이", "카카오페이 편의점 결제 2천원 쿠폰", "쿠폰/이벤트", 2000, 100, 0.6, 18, { isHot: true, isNew: true, isEndingSoon: true }, ["쿠폰", "편의점", "페이", "마감임박"], 90, "", "https://kakaopay.com/services/life/payment?t_ch=main&t_src=homepage"),
  deal("d055", "토스", "토스 출석체크 매일 포인트 적립", "쿠폰/이벤트", 1000, 100, 1, 72, { isHot: true, isNew: false, isEndingSoon: false }, ["출석체크", "포인트", "앱테크", "오늘만"], 88, "", "https://toss.im/tossfeed/article/tosspay-2025-02"),
  deal("d056", "CJ ONE", "CJ ONE 공식 진행중 이벤트·멤버십 쿠폰", "쿠폰/이벤트", 5000, 100, 2, 48, { isHot: false, isNew: true, isEndingSoon: false }, ["멤버십", "쿠폰", "포인트", "공식이벤트"], 82, "", "https://www.cjone.com/cjmweb/event-coupon/event.do"),
  ...
  deal("d058", "맥도날드", "맥도날드 공식 해피스낵 프로모션", "쿠폰/이벤트", 3500, 30, 0.4, 12, { isHot: true, isNew: true, isEndingSoon: true }, ["외식", "프로모션", "공식혜택", "간식"], 92, "", "https://www.mcdonalds.co.kr/kor/promotion/detail.do?seq=593"),
  deal("d059", "아모레몰", "아모레몰 결제혜택 모아보기와 첫구매 쿠폰", "뷰티", 20000, 20, 3, 36, { isHot: false, isNew: true, isEndingSoon: false }, ["첫구매", "결제혜택", "쿠폰", "뷰티"], 78, "", "https://www.amoremall.com/kr/ko/display/event_detail?planDisplaySn=6438"),
  deal("d060", "메가박스", "메가박스 공식 영화·문화 이벤트", "여행/티켓", 14000, 100, 2, 20, { isHot: true, isNew: true, isEndingSoon: false }, ["영화", "문화", "시사회", "공식혜택"], 85, "", "https://www.megabox.co.kr/event"),
  ...
  deal("d063", "홈플러스", "홈플러스 AI 물가안정 프로젝트 장보기 특가", "편의점/마트", 6490, 10, 1, 30, { isHot: true, isNew: true, isEndingSoon: false }, ["마트", "장보기", "공식상품", "물가안정"], 87, "", "https://front.homeplus.co.kr/product/191599407"),
  ...
  deal("d067", "KT멤버십", "KT멤버십 영화·외식 할인 쿠폰 모음", "쿠폰/이벤트", 8000, 100, 3, 72, { isHot: false, isNew: true, isEndingSoon: false }, ["통신사", "멤버십", "영화", "외식"], 80, "", "https://membership.kt.com/discount/partner/C23/67/PartnerDetail.do"),
  ...
  deal("d069", "맘큐", "맘큐 육아용품 샘플팩·체험 이벤트", "육아", 9900, 100, 4, 48, { isHot: true, isNew: true, isEndingSoon: false }, ["육아", "무료 샘플", "체험단", "배송비 확인"], 84, "", "https://www.momq.co.kr/event"),
  deal("d070", "아이챌린지", "아이챌린지 베이비 월령별 무료체험교재", "육아", 12000, 100, 4, 96, { isHot: false, isNew: true, isEndingSoon: false }, ["육아", "무료체험", "교재신청", "배송비무료"], 81, "", "https://m.i-challenge.co.kr/event/freetrial_r1/index.asp"),
  deal("d071", "카카오페이", "카카오페이 멤버십 적립·쿠폰 혜택", "쿠폰/이벤트", 3000, 100, 0.5, 16, { isHot: true, isNew: true, isEndingSoon: true }, ["페이", "포인트", "멤버십", "앱테크"], 91, "", "https://www.kakaopay.com/services/life/membership"),
  deal("d072", "네이버플러스", "네이버플러스 멤버십 무료 체험 혜택", "쿠폰/이벤트", 4900, 100, 1.2, 36, { isHot: true, isNew: true, isEndingSoon: false }, ["무료체험", "멤버십", "포인트", "첫 구매"], 89, "", "https://nid.naver.com/membership/join"),
  ...
  deal("d078", "티켓링크", "티켓링크 전시·공연 할인 이벤트", "여행/티켓", 20000, 100, 1.4, 42, { isHot: false, isNew: true, isEndingSoon: false }, ["전시", "공연", "무료 초대권", "티켓"], 82, "", "https://www.ticketlink.co.kr/event/main"),
  ...
  deal("d085", "쿠팡", "하기스 2024 매직컴포트 팬티형 기저귀 5단계 84매", "육아", 49800, 20, 1.3, 32, { isHot: false, isNew: true, isEndingSoon: false }, ["육아", "기저귀", "무료배송"], 78, "", "https://www.coupang.com/vp/products/7956680597?categoryId=502159&itemId=24502713557&sourceType=CATEGORY&vendorItemId=89031970736"),
  ...
  deal("d094", "올리브영", "스킨푸드 캐롯 카로틴 수딩 토너 300ml", "뷰티", 26000, 20, 0.8, 22, { isHot: true, isNew: true, isEndingSoon: false }, ["오늘드림", "수딩토너", "쿠폰적용"], 88, "https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/10/0000/0017/A00000017697808ko.jpg?l=ko", "https://www.oliveyoung.co.kr/store/goods/getGoodsDetail.do?goodsNo=A000000176978"),
  ...
  deal("d112", "무신사", "커버낫 X 미즈노 쿨 코튼 모티베이션 그래픽 티셔츠", "의류", 59000, 10, 1.8, 28, { isHot: false, isNew: true, isEndingSoon: false }, ["패션", "브랜드", "무배"], 78, "", "https://www.musinsa.com/products/6245413"),
  ...
  deal("d115", "BHC", "BHC 앱 치킨 첫 주문 5천원 할인 쿠폰", "쿠폰/이벤트", 5000, 100, 0.5, 14, { isHot: true, isNew: true, isEndingSoon: true }, ["배달", "외식", "첫 구매", "쿠폰"], 91, "", "https://www.bhc.co.kr/eCoupon/purchase"),
  deal("d116", "무신사", "무신사 온라인 할인 쿠폰 2026", "쿠폰/이벤트", 15000, 100, 0.6, 24, { isHot: true, isNew: true, isEndingSoon: false }, ["무료쿠폰", "패션", "공식혜택", "무신사"], 88, "", "https://www.musinsa.com/coupon-service/coupon/coupon_online"),
  deal("d117", "메가MGC커피", "메가MGC커피 앱 가입 쿠폰 공식 소식", "쿠폰/이벤트", 1000, 100, 0.4, 12, { isHot: true, isNew: true, isEndingSoon: true }, ["무료", "커피", "앱가입", "소식"], 87, "", "https://www.mega-mgccoffee.com/bbs/?bbs_category=2"),
